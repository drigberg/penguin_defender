 ...
 */
(function main() {
  planck.testbed('Penguin Defender', function(testbed) {
    testbed.y = -5
    testbed.hz = 1000;
    testbed.speed = 0.01;
    /**
    ...
    class Game {
      ...
      setupCollisionHandlers() {
        ...
        this.collisionHandlers = {
          [that.hashTypes(TYPES.GROUND, TYPES.HERO)]: function(bodies, point, fixtures) {
            if (!that.hero.body.getLinearVelocity().y || !fixtures.find(item => item.stomp === true)) {
              that.hero.land()
            }
          },
